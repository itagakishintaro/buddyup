      ...
      <div class="container">
        ...
        <div class="clearfix">
          ...
          <paper-input
            ...
            label="password"
          ></paper-input>
          <paper-button raised class="on" on-click="login"
            >ログイン</paper-button
          >
        </div>
        <div class="or">または</div>
        <button class="sns google" on-click="googleLogin">
          Googleでログイン
        </button>
        <button class="sns facebook" on-click="facebookLogin">
          Facebookでログイン
        </button>
        <hr />
        ...
        <div class="clearfix">
          ...
          <paper-input
            ...
            label="password"
          ></paper-input>
          <paper-button raised class="on" on-click="signup"
            >ユーザー登録</paper-button
          >
        </div>
      </div>
